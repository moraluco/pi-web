...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.askUser.title": "代理正在提问",
    "chat.askUser.review": "确认",
    "chat.askUser.elaborate": "提交并详述",
    "chat.askUser.custom": "自定义回答…",
    "chat.askUser.note": "为该问题添加备注（可选）",
    "chat.askUser.noteLabel": "备注",
