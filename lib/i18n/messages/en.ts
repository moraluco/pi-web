...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.askUser.title": "The agent is asking",
    "chat.askUser.review": "Review",
    "chat.askUser.elaborate": "Submit & elaborate",
    "chat.askUser.custom": "Type your own…",
    "chat.askUser.note": "Add a note for this question (optional)",
    "chat.askUser.noteLabel": "Note",
